...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DjR_40os.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 overflow-hidden rounded-[var(--radius-sm)] bg-[var(--color-fg)] px-2 py-1 text-xs text-[var(--color-bg)] shadow-sm", className),
	...props
}) }));
TooltipContent.displayName = Content2.displayName;
var styles_default = "/assets/styles-BSuV4B4q.css";
var APP_NAME = "Moi Traty";
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TooltipProvider, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
						...
						theme: "system",
						toastOptions: { className: "!bg-[var(--color-surface)] !text-[var(--color-fg)] !border-[var(--color-border)]" }
					})]
				}) }),
...
var $$splitComponentImporter = () => import("./routes-PyXdNZZa.mjs");
